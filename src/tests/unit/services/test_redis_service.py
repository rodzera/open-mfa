...
def test_client_is_none_for_testing_env():
    assert redis_service.client is None

def test_db_method(mocker):
...
def test_insert_hset_method(mocker):
...
def test_setup_connection_method(mocker):
